...
function main()
   ...
   sampRegisterChatCommand("smoke",cmd_smoke)
...
if #arg ~= 0 then
  lua_thread.create(function() 
    ...
    sampSendChat("/do Кейс в правой руке.")
  wait(1200)
...
sampSendChat('/invite '.. arg)
  ...
  sampAddChatMessage("[Ошибка] Укажите айди игрока,которого хотите пригласить в организацию",-1)
end
end
...
function cmd_uninvite(arg)
  ...
  sampSendChat("/do В кармане у ".. u8:decode(nickname.v) .. " находится КПК.")
  wait(1200)
  sampSendChat("/me легким движением руки достал КПК из своего кармана,затем выбрал список сотрудников")
  wait(1200)
  sampSendChat("/do Список сотрудников открыт.")
  wait(1200)
  sampSendChat("/me выбрал сотрудника и обнулил его информацию")
  wait(1200)
...
lua_thread.create(function() 
sampSendChat("/do На груди висит боди-камера.")
wait(1200)
sampSendChat("/me легким движением правой руки включил боди-камеру")
wait(1200)
sampSendChat("/do Боди-камера включена и ведет запись.")
end)
...
sampSendChat("/smoke")
sampSendChat("Еще одну я покурю,ведь я не тороплюсь.")
